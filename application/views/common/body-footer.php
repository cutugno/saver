                    ...
                    <div class="row">
                         ...
                         <div class="footer_teaser col-sm-4 col-md-4">
                              ...
                              <ul class="media-list">
									 ...
									 <li class="media"> <a href="<?php echo site_url(strtolower($val->categoria.'/'.$val->slug.'/'.$val->id)); ?>" class="media-photo" style="background-image:url(<?php echo ($val->allegati!="") ? base_url($val->allegati->url) : base_url('images/no_img.jpg'); ?>)"></a> <a href="#" class="media-date"><?php echo $val->data_ins['giorno']; ?><span><?php echo $val->data_ins['mese']; ?></span></a>
