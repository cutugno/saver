...
<script type="text/javascript" src="<?php echo base_url('js/modernizr.custom.48287.js'); ?>"></script>
<!-- Fav and touch icons -->
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url('images/apple-touch-icon-114x114-precomposed.png'); ?>">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url('images/apple-touch-icon-72x72-precomposed.png'); ?>">
